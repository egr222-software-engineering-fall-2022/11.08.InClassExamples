...
//        VariousRemoval.removeAll(list, "hello");
//        VariousRemoval.removeAll1(list, "hello");
//        VariousRemoval.removeAll2(list, "hello");
//        VariousRemoval.removeAll3(list, "hello");
//        VariousRemoval.removeAll4(list, "hello");
        VariousRemoval.removeAll5(list, "hello");
